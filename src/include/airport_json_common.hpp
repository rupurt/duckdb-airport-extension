...
namespace duckdb
{
	...
	class AirportJSONAllocator
	{
	public:
		explicit AirportJSONAllocator(Allocator &allocator)
	...
	struct AirportJSONKey
	{
		const char *ptr;
		size_t len;
	};

	struct AirportJSONKeyHash
	{
		inline std::size_t operator()(const AirportJSONKey &k) const
		{
			size_t result;
	...
	struct AirportJSONKeyEquality
	{
		inline bool operator()(const AirportJSONKey &a, const AirportJSONKey &b) const
		{
			if (a.len != b.len)
			{
				return false;
	...
	template <typename T>
	using json_key_map_t = unordered_map<AirportJSONKey, T, AirportJSONKeyHash, AirportJSONKeyEquality>;
	using json_key_set_t = unordered_set<AirportJSONKey, AirportJSONKeyHash, AirportJSONKeyEquality>;

	//! Common JSON functionality for most JSON functions
	struct AirportJSONCommon
	{
	public:
		//! Read/Write flags
	...
	public:
		...
		static inline const char *ValTypeToString(yyjson_val *val)
		{
			...
			case YYJSON_TYPE_NULL | YYJSON_SUBTYPE_NONE:
				return AirportJSONCommon::TYPE_STRING_NULL;
			case YYJSON_TYPE_STR | YYJSON_SUBTYPE_NOESC:
			case YYJSON_TYPE_STR | YYJSON_SUBTYPE_NONE:
				return AirportJSONCommon::TYPE_STRING_VARCHAR;
			case YYJSON_TYPE_ARR | YYJSON_SUBTYPE_NONE:
				return AirportJSONCommon::TYPE_STRING_ARRAY;
			case YYJSON_TYPE_OBJ | YYJSON_SUBTYPE_NONE:
				return AirportJSONCommon::TYPE_STRING_OBJECT;
			case YYJSON_TYPE_BOOL | YYJSON_SUBTYPE_TRUE:
			case YYJSON_TYPE_BOOL | YYJSON_SUBTYPE_FALSE:
				return AirportJSONCommon::TYPE_STRING_BOOLEAN;
			case YYJSON_TYPE_NUM | YYJSON_SUBTYPE_UINT:
				return AirportJSONCommon::TYPE_STRING_UBIGINT;
			case YYJSON_TYPE_NUM | YYJSON_SUBTYPE_SINT:
				return AirportJSONCommon::TYPE_STRING_BIGINT;
			case YYJSON_TYPE_NUM | YYJSON_SUBTYPE_REAL:
				return AirportJSONCommon::TYPE_STRING_DOUBLE;
			default:
	...
	template <>
	inline char *AirportJSONCommon::WriteVal(yyjson_val *val, yyjson_alc *alc, idx_t &len)
	{
		return yyjson_val_write_opts(val, AirportJSONCommon::WRITE_FLAG, alc, reinterpret_cast<size_t *>(&len), nullptr);
	}
	template <>
	inline char *AirportJSONCommon::WriteVal(yyjson_mut_val *val, yyjson_alc *alc, idx_t &len)
	{
		return yyjson_mut_val_write_opts(val, AirportJSONCommon::WRITE_FLAG, alc, reinterpret_cast<size_t *>(&len), nullptr);
	}
