...
struct AirportJsonSerializer : Serializer {
private:
	yyjson_mut_doc *doc;
...
public:
	explicit AirportJsonSerializer(yyjson_mut_doc *doc, bool skip_if_null, bool skip_if_empty, bool skip_if_default)
	...
	static yyjson_mut_val *Serialize(T &value, yyjson_mut_doc *doc, bool skip_if_null, bool skip_if_empty,
		...
		AirportJsonSerializer serializer(doc, skip_if_null, skip_if_empty, skip_if_default);
